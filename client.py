...
def askPlayerName():
    ...
    canvas1 =  Canvas(nameWindow,width=100,height=100)
    ...
    button = Button(nameWindow, text="Save", font=("Chalkboard SE", 30),width=15,command=saveName,height=2,bd=3,bg="#80DEEA")
